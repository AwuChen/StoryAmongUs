...
public class CallAppUi : MonoBehaviour
{
    ...
    public virtual void UpdateLocalTexture(IFrame frame)
    {
        if (uLocalVideoImage != null)
        {
            if (frame != null)
            {
                ...
                mLocalVideoFormat = frame.Format;
    ...
    /// </summary>
    /// <param name="frame"></param>
    public virtual void UpdateRemoteTexture(IFrame frame)
    {
        if (uRemoteVideoImage != null)
        {
            if (frame != null)
            {
                ...
                mRemoteVideoFormat = frame.Format;
